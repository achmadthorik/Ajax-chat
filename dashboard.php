...
.w3-input{padding:10px;display:block;border:1px solid #ccc; width:100%; 
 ...
 .btun{
    ...
    <body>
        ...
        <button class="btn btn-danger my-2 my-sm-0" onclick="window.location.href='index.php'" >LOG OUT</button>
        ...
        <div class="message-area">
	        <form method="post">
	        	...
	        	<input type="text"  name="message" id="message" placeholder="Type message here"/>
                 ...
                 <br><hr>
                 <button type="submit" class="btn btn-outline-primary btn-lg btn-block">KIRIM</button>
